...
${OBJECTDIR}/libexo/exo-test.o: libexo/exo-test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libexo/exo-test.o libexo/exo-test.c

${OBJECTDIR}/libexo/libexo.o: libexo/libexo.c 
	${MKDIR} -p ${OBJECTDIR}/libexo
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/libexo/libexo.o libexo/libexo.c
...
${OBJECTDIR}/sim-outorder.o: sim-outorder.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sim-outorder.o sim-outorder.cpp
