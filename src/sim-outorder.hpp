...
/*PX's Custom END*/
 ...
 unsigned int max_insts = 0;
 int fastfwd_count = 0;
 int ptrace_nelt = 0;
 char *ptrace_opts[2]={NULL, NULL};
 int ruu_ifq_size = 0;
 int ruu_branch_penalty = 0;
 int fetch_speed = 0;
 char *pred_type = NULL;
 int bimod_nelt = 0;
 ...
 int ruu_decode_width = 0;
 int ruu_issue_width = 0;
 int ruu_inorder_issue = 0;
 int ruu_include_spec = 0;
 int ruu_commit_width = 0;
 int RUU_size = 0;
 int LSQ_size = 0;
 ...
 tick_t sim_cycle = 0;
 counter_t IFQ_count = 0;		
 counter_t IFQ_fcount = 0;		
 counter_t RUU_count = 0;		
 counter_t RUU_fcount = 0;		
 counter_t LSQ_count = 0;		
 counter_t LSQ_fcount = 0;		
 counter_t sim_invalid_addrs = 0;
...
#define BITMAP_TYPE(BITS, NAME)	unsigned int (NAME)[BITMAP_SIZE(BITS)]
 ...
 md_addr_t fetch_regs_PC = 0;
 md_addr_t fetch_pred_PC = 0;
